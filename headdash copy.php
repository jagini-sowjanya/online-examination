  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="headdash.php?q=1">Student</a></li>
...
<tr><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td><b>positive</b></td><td><b>negative</b></td><td><b>Time limit</b></td><td><b>Start time</b></td><td><b>End time</b></td><td><b>Created By</b></td><td></td></tr>';
$c=1;
...
<tr><td><b>S.N.</b></td><td><b>Lab Name</b></td><td><b>Total Questions</b></td><td><b>Total Marks</b></td><td><b>Marks per Qn</b></td><td><b>Duration</b></td><td><b>Start Time</b></td><td><b>End Time</b></td><td><b>Created By</b></td></tr>';
$c=1;
while($row_lab = mysqli_fetch_array($result_lab)) {
  ...
  if($rowcount_lab == 0){
    echo '<tr><td>'.$c++.'</td><td>'.$lab_name.'</td><td>'.$total.'</td><td>'.$right * $total.'</td><td>'.$right.'</td><td>'.$duration.'&nbsp;min</td><td>'.$start_time.'</td><td>'.$end_time.'</td><td>'.$teacher_mail.'</td></tr>';
  } 
}
$c=0;
echo '</table></div>';
