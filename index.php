...
<!--   
  <script>
  let switchCount = 0; // Counter to keep track of tab switches
  const maxSwitches = 3; // Maximum allowed tab switches before taking action
  ...
  document.addEventListener("visibilitychange", function () {
    if (document.visibilityState === "hidden") {
      ...
      switchCount++;
      alert("Warning: You have switched tabs! This may affect your test attempt.");

      if (switchCount >= maxSwitches) {
        // Take further action if the user switches tabs too many times
        alert("You have switched tabs too many times. Your test may be invalidated.");
        // You can add code here to stop the test or report the activity
      }
    }
  });
</script> -->
...
function validateForm() {
  ...
  if(a == null || a == ""){
    ...
    return false;}if(a.length<5 || a.length>25){alert("Passwords must be 5 to 25 characters long.");return false;}
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#" data-toggle="modal" data-target="#authModal">LOGIN / SIGN UP</a></li>
...
<div class="form-group">
<input type="text" name="uname" maxlength="50"  placeholder="Teacher user id" class="form-control"/> 
</div>
<div class="form-group">
<input type="password" name="password" maxlength="15" placeholder="Password" class="form-control"/>
</div>
...
<!-- Combined Modal for Sign In / Sign Up -->
    ...
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <ul class="nav nav-tabs" role="tablist">
          <li class="active"><a href="#loginTab" role="tab" data-toggle="tab">Login</a></li>
          <li><a href="#signupTab" role="tab" data-toggle="tab">Sign Up</a></li>
        </ul>
      </div>
      ...
      <div class="modal-body tab-content">
        ...
        <div class="tab-pane active" id="loginTab">
          <form class="form-horizontal" action="login.php?q=index.php" method="POST">
            <fieldset>
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input name="password" placeholder="Enter your Password" class="form-control" type="password" required>
                </div>
              </div>
        ...
        <div class="tab-pane" id="signupTab">
          ...
          <fieldset>
            ...
            <div class="form-group">
              <div class="col-md-12">
                <input id="signupEmail" name="email" placeholder="Enter your email-id" class="form-control" required pattern="^n[0-9]+@rguktn\.ac\.in$"  title="Email must end with '@rguktn.ac.in'" type="email" required>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-md-12">
                <input name="otp" id="otp" placeholder="Enter OTP" class="form-control" type="text" required>
              </div>
            </div>

            <div class="form-group">
              <div class="col-md-12">
                <input name="mob" placeholder="Enter your mobile number" class="form-control" type="number" required>
              </div>
            </div>
            <div class="form-group">
              <div class="col-md-12">
            ...
            <?php if(@$_GET['q7']) { echo'<p style="color:red;">'.@$_GET['q7'].'</p>'; } ?>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-map-marker"></span> Nuzvid, INDIA</p>
      <p><span class="glyphicon glyphicon-phone"></span> +91 9391872342 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> sravanpotnuru24@gmail.com</p>
    </div>
...
<script>
function myMap() {
var myCenter = new google.maps.LatLng(16.7911, 80.8226);
...
function sendOTP() {
    ...
    .then(data => {
        alert(data); // You can improve with toast or modal
    })
    .catch(error => {
